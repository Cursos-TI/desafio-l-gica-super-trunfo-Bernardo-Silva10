...
int main(){
    ...
    int população = 4,145.000.000;                 // População da cidade        
    int pontosTuristicos = 21;              // Número de pontos turísticos
    char codigo[5] = "A01";                 // Código da carta (string de até 4 caracteres + '\0')        
    char estado[20] = "Paraíba";        // Nome do estado (até 19 caracteres + '\0')
    char cidade[20] = "João Pessoa";         // Nome da cidade
    double area = 56 467,242 km²;                    // Área da cidade em km²
    double pib = 4,7 % ;               // Produto Interno Bruto da cidade
   ...
   printf ( " Carta 2 veceu\n");
   else 

   printf ( " Empate\n" );
   }
   // comparação entre as cartas 
   printf (" A carta1 %s tem mais pontos turisticos que a carta2 %s ? %d\n", codigo, codigo2, pontosTuristicos2 > pontosTuristicos1 ); ")
   printf (" A carta2 %s tem menos pontos turisticos que a carta1 %s ? %d\n", codigo2, codigo1, pontosTuristicos1 < ponstosTuristicos2 );
